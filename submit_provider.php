...
// Captcha removed from public submissions per admin request. Admin login still requires Turnstile.
// Previously: $turnstile_response checks and server-side verification were here and have been removed.
// This keeps submit flow open (counts-only submissions do not require CAPTCHA now).
...
try {
    ...
    if (ob_get_length()) ob_clean();
    // nosemgrep: echoed-request, taint-unsafe-echo-tag
